...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="<?= site_url('/alat/update') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>

                <input type="hidden" name="IdAlat" value="<?= esc($alat['IdAlat']) ?>">
                <input type="hidden" name="LokasiFotoLama" value="<?= esc($alat['LokasiFoto']) ?>">

                <!-- Nama Alat -->
                <div class="form-group">
                    <label for="NamaAlat">Nama Alat</label>
                    <input type="text" class="form-control <?= session('validation.NamaAlat') ? 'is-invalid' : '' ?>" 
                           id="NamaAlat" name="NamaAlat" value="<?= old('NamaAlat', $alat['NamaAlat']) ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('validation.MerkType') ? 'is-invalid' : '' ?>" 
                           id="MerkType" name="MerkType" value="<?= old('MerkType', $alat['MerkType']) ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('validation.Lokasi') ? 'is-invalid' : '' ?>" 
                           id="Lokasi" name="Lokasi" value="<?= old('Lokasi', $alat['Lokasi']) ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">
                        Kosongkan jika tidak ingin mengganti foto alat.
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= session('validation.Fungsi') ? 'is-invalid' : '' ?>" 
                              id="Fungsi" name="Fungsi"><?= old('Fungsi', $alat['Fungsi']) ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('validation.Pemakai') ? 'is-invalid' : '' ?>" 
                           id="Pemakai" name="Pemakai" value="<?= old('Pemakai', $alat['Pemakai']) ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control <?= session('validation.Status') ? 'is-invalid' : '' ?>" 
                        ...
                        <option value="Tidak Aktif" <?= old('Status', $alat['Status']) == 'Tidak Aktif' ? 'selected' : '' ?>>Tidak Aktif</option>
                    </select>
                    <div class="invalid-feedback">
